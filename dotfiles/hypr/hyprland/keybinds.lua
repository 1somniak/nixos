...
local azerty_keys = {
    [1] = { "1", "ampersand", "code:10" },
    [2] = { "2", "eacute", "code:11" },
    [3] = { "3", "quotedbl", "code:12" },
    [4] = { "4", "apostrophe", "code:13" },
    [5] = { "5", "parenleft", "code:14" },
    [6] = { "6", "minus", "code:15" },
    [7] = { "7", "egrave", "code:16" },
    [8] = { "8", "underscore", "code:17" },
    [9] = { "9", "ccedilla", "code:18" },
    [10] = { "0", "agrave", "code:19" },
}

for i = 1, 10 do
    for _, key in ipairs(azerty_keys[i]) do
